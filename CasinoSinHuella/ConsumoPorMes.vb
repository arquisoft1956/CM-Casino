...
Public Class ConsumoPorMes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CasinoSinHuella.ConsumoPorMes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedConsumoPorMes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ConsumoPorMes = New ConsumoPorMes()
        rpt.Site = Me.Site
        Return rpt
    End Function
