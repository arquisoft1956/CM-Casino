...
Namespace Security
  ...
  Public Class PTIdentity
        ...
        Implements IIdentity, IIdUser
#Region " IIdUser "
        Private mID As Int16
        Public ReadOnly Property IDUser() As Int16 Implements IIdUser.IDUser
